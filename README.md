...
<p>
    Пользователям доступна возможность добавлять/изменять/удалять кандидатов. У кандидата должно быть имя и город (что бы добавить города в список нужно создать новую миграцию, пример можно посмотреть в <code>db/scripts/update_006.sql</code>). После того как кандидат был создан, ему можно добавить одну фотографию. При удалении кандидата удаляется и его фотография. 
</p>
<p align="center">
